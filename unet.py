# Adapted from pykao/Modified-3D-UNet-Pytorch/
# Since the data tensor is dwonsampled 4 times, input tensor needs to be a multiple of 16
...
class Modified3DUNet(nn.Module):
	def __init__(self, in_channels, n_classes, base_n_filter = 8):
		...
		# change probability of dropping elements to 0.2 from a crazy 0.6 earlier
